define(function (require, exports, module) {
    ...
    var urls = {
        manager: CONTEXT_PATH + '/flow/flowManager.do',
    ...
    var constWidgets = [
        ...
        { id: 'Location', code: '', des: '定位', en_name: 'Location', name: '定位', type: '定位' }
    ];
    ...
    var widgetConfig = {
        ...
        'NumberField': {
            template: 'normal',
            settings: ['label', 'placeholder', 'alias', 'required', 'integer', 'tosum', 'canimport', 'readonly'], //'unit', 没有对应字段注释掉
            defaultData: {
                label: '数字输入框',
                placeholder: '请输入',
                unit: '',
        ...
        'DDSelectField': {
            template: 'normal',
            settings: ['label', 'options', 'alias', 'required', 'canimport'],
            defaultData: {
                label: '单选框',
                placeholder: '请选择',
                required: false,
        ...
        'DDDateField': {
            template: 'normal',
            settings: ['label', 'timeformat', 'alias', 'required'],
            defaultData: {
                label: '日期',
                placeholder: '请选择',
                required: false,
        ...
        'MoneyField': {
            template: 'normal',
            settings: ['label', 'placeholder', 'alias', 'required', 'tosum', 'canimport', 'readonly'],
            defaultData: {
                label: '金额',
                placeholder: '请输入',
                required: false
        ...
        'ComputeField': {
            template: 'normal',
            settings: ['label', 'alias', 'compute', 'explain-compute'],
            defaultData: {
                label: '数值计算'
            }
        },
        ...
        'Location': {
            template: 'location',
            settings: ['label', 'location', 'alias', 'readonly'],
            defaultData: {
                label: '定位',
                placeholder: '0',
                multi: false,
        ...
        toDataJSON: function () {
            if (!this.setting.valid()) {
                ...
                var model = _.extend({}, emptySettingJson, {
                    ...
                    field1: null,   //预留字段，有新属性使用这3个预留字段，不要再加新字段
