...
<div class="design-wrap">
    <div class="design-header">
        <div class="head-title" >
            ...
            <span class="design-header-note">表单设计器</span>
        </div>
...
<script id="tmpl-widget-location" type="text/html">
    <div class="design-remove icon icon-close"></div>
    <div class="design-componentview" >
        <div class="design-componentview-border">
            <div class="design-componentview-button">
...
<script id="tmpl-setting-alias" type="text/html">
    <div class="design-field design-setting-placeholder">
        ...
        <div class="fieldblock">
            <input name="alias" type="text" value="{{alias}}" maxlength="10" {{useAlias ? '' : 'disabled'}}>
        </div>
    </div>
</script>
...
<script id="tmpl-setting-location" type="text/html">
    <div class="design-field design-setting-label">
        <div class="fieldname">
            <span>定位信息</span>
            <span class="fieldinfo"></span>
        ...
        <div class="fieldblock">
            <select name="placeholder">
                <option value="0" {{ placeholder == '0' ? 'selected' : '' }}>位置</option>
                <option value="1" {{ placeholder == '1' ? 'selected' : '' }}>位置和时间</option>
            </select>
        </div>
    </div>
</script>
...
<script>
    var UUID = '${UUID}';
    seajs.use('page/edition-third/flow/edit-form', function (module) {
        module.run();
    });
</script>
</body>
