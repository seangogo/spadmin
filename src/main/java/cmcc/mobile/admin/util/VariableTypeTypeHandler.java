 ...
 */
@Component
public class VariableTypeTypeHandler implements TypeHandler<VariableType> {
	...
	protected VariableTypes getVariableTypes() {
		if (variableTypes == null) {
			variableTypes = ((ProcessEngineConfigurationImpl) ApplicationContextHelper.getBean("processEngineConfiguration"))
					.getVariableTypes();
		}
